...
@interface WindowHotzoneData : NSObject
{
    NSRect _topLeftHotzone;
    
    NSRect _topRightHotzone;
    
    NSRect _bottomLeftHotzone;
    
    NSRect _bottomRightHotzone;
    
    NSRect _leftHotzone;
    
    NSRect _rightHotzone;
    
    NSRect _topHotzone;
    
    NSRect _bottomHotzone;
